...
-- Lecture : staff ou enseignant propriétaire
...
-- Création : enseignant uniquement, pour lui-même
...
-- Notifications système (pré-inscriptions, etc.)
...
-- Notifier gérant + secrétariat à chaque nouvelle pré-inscription
...
-- Realtime pour listes staff / enseignant
do $$
begin
  if not exists (
