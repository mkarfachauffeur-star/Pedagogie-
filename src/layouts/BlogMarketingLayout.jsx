...
export function useBlogSkin() {
  ...
  return {
    ...
    skin: {
      ...
      eyebrowBlue: 'text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--lp-blue)]',
      card: 'rounded-[20px] border border-[var(--lp-border)] bg-[var(--lp-card)]',
      cardHover:
        'group relative overflow-hidden rounded-[20px] border border-[var(--lp-border)] bg-[var(--lp-card)] p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:border-[var(--lp-blue)] hover:shadow-[0_8px_32px_rgba(23,105,255,0.12)]',
      loginBtn:
