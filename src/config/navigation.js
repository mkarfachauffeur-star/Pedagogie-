export const NAVIGATION = {
  ...
  student: {
    ...
    items: [
      ...
      { href: '/student/progress', icon: '\u{1F4C8}', label: 'Ma progression' },
  ...
  teacher: {
    ...
    items: [
      ...
      { href: '/teacher/lessons', icon: '\u{1F4DA}', label: 'Le\u00E7ons' },
      { href: '/teacher/resources', icon: '\u{1F4D6}', label: 'Ressources p\u00E9dagogiques' },
      { href: '/teacher/vehicles', icon: '\u{1F698}', label: 'Gestion des véhicules' },
      { href: '/teacher/messages', icon: '\u{1F4AC}', label: 'Messagerie' },
      { href: '/teacher/profile', icon: '\u{1F464}', label: 'Mon profil' },
    ],
  },
  secretary: {
