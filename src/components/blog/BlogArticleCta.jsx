  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row">
        <Link
          className="inline-flex items-center justify-center gap-2 rounded-[12px] bg-[var(--lp-cta-bg)] px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-[var(--lp-cta-hover)]"
          to="/#demonstration"
        >
