...
function StoreBadgeLink({ store, size }) {
  ...
  const className =
    'inline-flex items-center justify-center rounded-md transition hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400'
