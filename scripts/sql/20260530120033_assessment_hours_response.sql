-- =============================================================================
-- Migration 33 — Réponse élève à la proposition horaire (évaluation de départ)
-- Fichier source : supabase/migrations/20260530120033_assessment_hours_response.sql
-- Projet : watdeahravfccjdoseaf
--
-- Débloque :
--   • Finalisation évaluation (recommended_hours_response = 'pending')
--   • Badge acceptation / refus heures proposées
--   • RPC student_respond_recommended_hours (élève)
-- =============================================================================
